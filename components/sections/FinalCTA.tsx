        ...
        <div className="space-y-10">
          ...
          >
            ...
            <h2 className="font-display text-3xl sm:text-5xl md:text-6xl font-bold text-white tracking-tight leading-[1.12]">
              Vamos conversar <span className="text-zinc-400 font-light">sobre o seu projeto?</span>
            </h2>
            <p className="text-zinc-400 text-base sm:text-xl font-light leading-relaxed max-w-2xl mx-auto">
              Me conte o que você precisa, mesmo que ainda esteja só na ideia. Eu respondo em até 24 horas com o melhor caminho para o seu caso.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="pt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 border-t border-white/[0.06] max-w-3xl mx-auto text-center"
          >
            <div className="space-y-1">
              <span className="text-white font-display text-base font-semibold block">Até 24h</span>
              <span className="text-zinc-500 text-xs font-mono uppercase tracking-wider">Para a primeira resposta</span>
            </div>
            <div className="space-y-1">
              <span className="text-white font-display text-base font-semibold block">Direto comigo</span>
              <span className="text-zinc-500 text-xs font-mono uppercase tracking-wider">Sem intermediários</span>
            </div>
            <div className="space-y-1">
              <span className="text-white font-display text-base font-semibold block">Sigilo</span>
              <span className="text-zinc-500 text-xs font-mono uppercase tracking-wider">Seu projeto e seus dados protegidos</span>
            </div>
          </motion.div>
