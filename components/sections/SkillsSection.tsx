      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="group relative">
            ...
            <div className="relative bg-tech-surface p-10 rounded-[20px] border border-white/5 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-black/50 hover:border-tech-electric/40 transition-all duration-300 h-full">
          ...
          <motion.div variants={itemVariants} className="group relative">
            ...
            <div className="relative bg-tech-surface p-10 rounded-[20px] border border-white/5 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-black/50 hover:border-tech-gold/40 transition-all duration-300 h-full">
          ...
          <motion.div variants={itemVariants} className="group relative">
            ...
            <div className="relative bg-tech-surface p-10 rounded-[20px] border border-white/5 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-black/50 hover:border-white/30 transition-all duration-300 h-full">
