        ...
        >
          ...
          <div className="glass-panel p-8 rounded-2xl border-t border-tech-electric">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm text-tech-gray mb-2">Orçamento Estimado</label>
            ...
            <div className="mt-6">
              ...
              <textarea name="references" rows={2} className="w-full bg-tech-surface border border-tech-gray/30 rounded p-3 text-white"></textarea>
            </div>
